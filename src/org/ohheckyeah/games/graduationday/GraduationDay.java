package org.ohheckyeah.games.graduationday;

import java.text.SimpleDateFormat;
import java.util.Date;

import org.ohheckyeah.games.graduationday.assets.GraduationDayColors;
import org.ohheckyeah.games.graduationday.assets.GraduationDayGraphics;
import org.ohheckyeah.games.graduationday.assets.GraduationDaySounds;
import org.ohheckyeah.games.graduationday.game.GraduationDayGamePlay;
import org.ohheckyeah.games.graduationday.game.GraduationDayTracking;
import org.ohheckyeah.games.graduationday.screens.GraduationDayTitleScreen;
...
extends OHYBaseGame  
{
	...
	public static void main(String args[]) {
		...
		if( isSecondScreen ) {
			PApplet.main(new String[] { "--hide-stop", "--bgcolor=000000", "--location=-1280,0", "--display=1", GraduationDay.class.getName() });		// requires hiding os x 2nd screen menu bar: http://www.cultofmac.com/255910/hide-the-menu-bar-on-your-secondary-monitor-with-mavericks-os-x-tips/
		} else {
			PApplet.main(new String[] { "--hide-stop", "--bgcolor=000000", GraduationDay.class.getName() });
		}
	}

	// graphics
	public GraduationDayGraphics gameGraphics;

	// audio 
	public GraduationDaySounds sounds; 

//	protected GraduationDayLayout _gameLayout;
	protected GraduationDayGamePlay _gamePlay;
	protected GraduationDayTracking _tracking;
	...
	public void setup() {
		super.setup( "graduationday.properties", 864, 1536 );
		initGame();
	}
	...
	public void initGame() {
		...
		_introScreens = new OHYIntroScreens( new GraduationDayTitleScreen() );

		// set flags and props	
//		_gameLayout = new GraduationDayLayout();
		_gamePlay = new GraduationDayGamePlay(_joysticks);
		setInitialGameState();
		_tracking = new GraduationDayTracking();
	}
	
	protected void loadMedia() {
		ohySounds = sounds = new GraduationDaySounds();
		gameGraphics = new GraduationDayGraphics();
...
//		gameGraphics.shuffleCharacters();
	...
	protected void setGameStatePreCountdown() {
		...
		sounds.playSound( GraduationDaySounds.PLAYERS_DETECTED );
	}
	...
	protected void setGameStateCountdown() {
		...
		sounds.playSound( GraduationDaySounds.COUNTDOWN );
	}
	...
	protected void setGameStatePlaying() {
		...
		_gamePlay.startGame();
		sounds.playGameplay();
		sounds.playSound( GraduationDaySounds.GAMEPLAY_START );
	}
	...
	protected void setGameStateGameOver() {
		...
		// track gameplay!
//		_tracking.trackGameResult(_trackingDateStr, NUM_PLAYERS, GraduationDayGameTimer.GAME_LENGTH_SECONDS, _gamePlay.numWins(), _gamePlay.numFails(), _gamePlay.score() );
	}
	...
	public void drawApp() {
		...
		pg.beginDraw();
		pg.background( GraduationDayColors.STAGE_BG );
		pg.noStroke();
		runGameState();
		pg.endDraw();
