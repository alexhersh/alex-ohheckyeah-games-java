...
extends OHYBaseGame  
{
	...
	public static void main(String args[]) {
		...
		if( isSecondScreen ) {
			PApplet.main(new String[] { "--hide-stop", "--bgcolor=000000", "--location=-1280,0", "--display=1", BlueBear.class.getName() });		// requires hiding os x 2nd screen menu bar: http://www.cultofmac.com/255910/hide-the-menu-bar-on-your-secondary-monitor-with-mavericks-os-x-tips/
		} else {
			PApplet.main(new String[] { "--hide-stop", "--bgcolor=000000", BlueBear.class.getName() });
		}
	}
	...
	public void initGame() {
		...
		// set flags and props	
		_gamePlay = new BlueBearGamePlay( _joysticks );
		setInitialGameState();
